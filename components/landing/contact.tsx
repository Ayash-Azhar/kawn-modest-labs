        ...
        <section id="contact" className="py-24 bg-muted/20">
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <h2 className="text-4xl font-bold font-serif tracking-tight sm:text-5xl text-foreground">Get in Touch</h2>
                    ...
                    >
                        <div className="grid gap-6 p-8 bg-background shadow-sm border border-border/50">
                            <a
